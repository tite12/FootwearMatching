...
if (firstVersionPreprocessing) :
    ...
    # cv.destroyAllWindows()
    #
    # cv.imwrite(path + name + '_med5.jpg', median5)
    # cv.imwrite(path + name + '_med9.jpg', median9)
    cv.imwrite(path + name + '_bi5.jpg', bi5)
    cv.imwrite(path + name + '_bi5_small.jpg', bi5[0:50,0:50])

    # cv.imwrite(path + name + '_bi9.jpg', bi9)
    cv.imwrite(path + name + '_wiener.jpg', img_wiener)
    cv.imwrite(path + name + '_denoise.jpg', img_wienerBi5)
    #=============enhancement====================
    ...
    # cv.destroyAllWindows()
    #
    cv.imwrite(path + name + '_enhnace.jpg', smqtBi)
    # cv.imwrite(path + name + '_fuzzy.jpg', fuzzyBi)
    # cv.imwrite(path + name + '_enhance.jpg', smqtAndFuzzyBi)
    # cv.imwrite(path + name + '_adaptive.jpg', adaptiveBi)
    # cv.imwrite(path + name + '_adaptive_fuzzy.jpg', adaptiveAndFuzzyBi)
    # cv.imwrite(path + name + '_hist.jpg', histBi)
    # cv.imwrite(path + name + '_hist_fuzzy.jpg', histFuzzyBi)
    ...
    cv.imwrite(path + name + '_threshold.jpg', niblack)
    ...
    # morph = cv.morphologyEx(otsu, cv.MORPH_CLOSE, kernel)
    # morph = cv.morphologyEx(morph, cv.MORPH_OPEN, kernel)

    # cv.imwrite('C:/Users/rebeb/Documents/TU_Wien/Dipl/FID-300/FID-300/FID-300/test_images/results/images/orig/automated/' + name + '_smqt_bi.jpg', niblack)
    # cv.imwrite('C:/Users/rebeb/Documents/TU_Wien/Dipl/FID-300/FID-300/FID-300/test_images/results/images/orig/automated/' + name + '_hist_fuzzy.jpg', niblackHist)
    cv.imwrite(path + name + '_result.jpg', niblack)
