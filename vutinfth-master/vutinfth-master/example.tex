...
\begin{figure}[h]
  ...
  \caption{The workflow of the fully automated workflow algorithm.}
...
The kernel size onf the Bilateral Filter is the same as for Wiener Filter, 5x5.
...
The window size is the same as the size of the filter kernels, 5x5.
...
Chatterjee et al. \cite{chatterjee2011patch} proposed a method  which represents the estimated image based on geometrically and photometrically similar regions.
